(function() {
    ...
    */
    var nordeste = ['Rio Grande do Norte', 'Recife', 'Pernambuco'];
    ...
    */
    ...
    var estado = brasil.some(function(element) {
    ...
    */
    function addToArray(obj) {
        obj.id++;
        obj.estado += " pertence ao Brasil";
        return obj;
    }

    var map = newBrasil.map(addToArray);    
    ...
    */
    function evenId(item) {
        return item.id % 2 === 0;
    }
    var filter = map.filter(evenId);
