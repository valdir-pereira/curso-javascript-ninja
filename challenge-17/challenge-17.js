(function() {
    ...
    */
    ...
    var myName = text.replace(/Manuel Marques de Sousa/, 'Valdir Pereira Junior');
    console.log(myName);
    ...
    */
    ...
    var city = text.replace(/brasileiro/, 'paulista');
    console.log(city);
    ...
    */
    ...
    var changeNumbers = text.replace(/\d/g, '-');
    ...
    */
    ...
    // console.log( months.map(function(month, index) {
    //     return "O mês de " + month + " é representado pelo número " + (index + 1) + " .";    
    // }) );
    ...
    console.log(  "O mês de Setembro é representado pelo número " + getMonthNumber('julho') + "."  );
